...
writeFile = directory + 'Galaxies/Three_Area_Errors/0.0_Percent_' + str(rMagCut[0]) + '_' + str(rMagCut[1]) + '.fits'
...
persToUse = np.array([5, 10, 15, 20, 40, 60, 80, 100])
...
for perObjectsToUse in persToUse:
    ...
    writeFile = directory + 'Galaxies/Three_Area_Errors/' + str(perObjectsToUse) + '_Percent_' + str(rMagCut[0]) + '_' + str(rMagCut[1]) + '.fits'
    my_table = Table()
